...
const FAQ_ITEMS = [
  {
    ...
    a: "Зависит от сложности. Плановое ТО — 1 день, ремонт двигателя — 3–7 дней, полная реставрация — от 3 недель. Точные сроки назовём после диагностики.",
  },
  {
    q: "Вы работаете только с Vespa?",
    a: "Vespa — наша специализация и страсть. Но мы также берём в работу другие классические мотороллеры и скутеры премиум-сегмента. Напишите нам — подскажем.",
  },
  {
  ...
  },
  {
    ...
    a: "Конечно. У нас есть собственный мотоэвакуатор — доставим вашу технику по Москве и ближайшим областям. Стоимость — от 3 000 ₽.",
  },
  {
